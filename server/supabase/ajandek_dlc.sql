...
where lower(u.email) = 'parthenon841@gmail.com'
  and not exists (
...
-- where source = 'ajandek' and lower(email) = 'parthenon841@gmail.com';

-- ── Érme ajándékba (Kard és Mágia bolt) ──
-- insert into public.coin_tx (user_id, email, amount, reason)
-- select id, email, 100, 'ajandek' from auth.users where lower(email) = 'parthenon841@gmail.com';
